...
parser.add_argument('-i', '--input', dest='input', default='input1_4', help='File containing sentences to translate (default=data/input)')
...
file1=file('lagrange1_4','w+')
file0=file('result1_4','w+')
line_num=0
