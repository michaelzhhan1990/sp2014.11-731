...
parser.add_argument('-i', '--input', dest='input', default='input0_1', help='File containing sentences to translate (default=data/input)')
...
file1=file('lagrange0_1','w+')
file0=file('result0_1','w+')
line_num=0
