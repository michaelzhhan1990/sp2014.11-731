...
parser.add_argument('-i', '--input', dest='input', default='input0_10', help='File containing sentences to translate (default=data/input)')
...
file1=file('lagrange0_10','w+')
file0=file('result0_10','w+')
line_num=0
