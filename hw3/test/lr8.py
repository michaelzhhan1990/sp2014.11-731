...
parser.add_argument('-i', '--input', dest='input', default='input0_8', help='File containing sentences to translate (default=data/input)')
...
file1=file('lagrange0_8','w+')
file0=file('result0_8','w+')
line_num=0
