...
def extract_features(hyp, ref):
    ...
    return {'recall':1.5*recall,'retrun':recall_trun}
    #return {'recall':recall}
    #return {'prec':0.1*precision,'recall':2*recall,'trun_r':0.2*recall_trun,'trun_p':0.1*prec_trun}
    #return {'recall':recall,'trun_r':recall_trun}
    #return {'recall':recall}
