...
parser.add_argument('-i', '--input', dest='input', default='input3_3', help='File containing sentences to translate (default=data/input)')
...
file1=file('lagrange3_3','w+')
file0=file('result3_3','w+')
line_num=0
