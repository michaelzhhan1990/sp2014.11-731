...
parser.add_argument('-i', '--input', dest='input', default='input3_1', help='File containing sentences to translate (default=data/input)')
...
file1=file('lagrange3_1','w+')
file0=file('result3_1','w+')
line_num=0
