...
parser.add_argument('-i', '--input', dest='input', default='input0_4', help='File containing sentences to translate (default=data/input)')
...
file1=file('lagrange0_4','w+')
file0=file('result0_4','w+')
line_num=0
